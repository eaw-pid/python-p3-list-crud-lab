...
def create_a_list():
    return [str, True, 3, str]

#This function takes in two arguments, a list and the element we want to add to it. Use the append() method to add that element to the end of the new list.
